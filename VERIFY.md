...
Pick a release tag (`v2.1.0-rc7`, the current release, in the examples below) and pull the
...
release notes. Current release `v2.1.0-rc7`: index `2380986847`
(<https://search.sigstore.dev/?logIndex=2380986847>);
`v2.1.0-rc6`: index `2194858421`; `v2.1.0-rc5`: index `1911768787`.
